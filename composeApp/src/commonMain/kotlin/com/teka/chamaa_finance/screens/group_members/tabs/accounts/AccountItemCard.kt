...
@Composable
fun AccountItemCard(
    chamaAccount: ChamaAccountEntity,
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Column(
                    ...
                    Row(
                        ...
                        CustomText(
                            text = chamaAccount.accountName,
                            fontWeight = FontWeight.Bold,
                            color = Color.Black,
                            fontSize = TextSizeXLarge
                        )
                        CustomText(
                            text = chamaAccount.dateFormed,
                            fontSize = TextSizeMedium
                        )
                    }
                    LabelValueTextWidget(label = "AccountId: ", value = chamaAccount.accountId )
                }
            }
        }
    }
