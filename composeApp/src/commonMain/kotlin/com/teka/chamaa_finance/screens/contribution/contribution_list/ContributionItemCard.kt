        ...
        Column(modifier = Modifier.fillMaxWidth().padding(10.dp)) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Column(
                    ...
                    LabelValueTextWidget(label = "Account: ", value = contribution.chamaAccountId )
                    LabelValueTextWidget(label = "Amount: ", value = contribution.contributionAmount )
                }
            }
        }
    }
